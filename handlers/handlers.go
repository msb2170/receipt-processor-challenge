...
func CalculatePointsHandler(receipt models.Receipt) int {
    points := 0
...
func ProcessReceiptHandler(w http.ResponseWriter, r *http.Request) {
    ...
    points := CalculatePointsHandler(receipt)
...
// GetReceiptHandler handles the /receipts/{id} endpoint
func ReceiptIdHandler(w http.ResponseWriter, r *http.Request) {
    vars := mux.Vars(r)
    id := vars["id"]
